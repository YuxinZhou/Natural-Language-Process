...
class TestSequenceFunctions(unittest.TestCase):
    ...
    def test_numbers(self):
        s = []
        try: self.assertEqual(" ".join(self.french.transduce(prepare_input(0))), "zero")
        except: s.append(1)
    ...
    def test_morphology(self):
        ...
        try: self.assertEqual(generate("arc+ed"), "arced")
        except: s.append(9)
        try: self.assertEqual(generate("ice+ed"), "iced")
        except: s.append(10)
        try: self.assertEqual(generate("c+ed"), "ced")
        except: s.append(11)
