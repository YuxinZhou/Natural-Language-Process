...
class TestSequenceFunctions(unittest.TestCase):
    ...
    def test_rhyme(self):
        ...
        try:
            ...
            s.append(18)
        try:
            self.assertEqual(self.ld.rhymes("aye", "die"), True)
        except:
            s.append(19)
        try:
            self.assertEqual(self.ld.rhymes("house", "mouse"), True)
        except:
            s.append(20)
        try:
            self.assertEqual(self.ld.rhymes("butterfly", "fly"), False)
        except:
            s.append(21)
    ...
    def test_examples(self):
        ...
        test_list = ["" for i in xrange(13)]
        # 0 all lines should have at least 4 syllables
        test_list[0] = """
        ...
        # 1-5 A/B lines should not differ in their number of syllables by more than 2
        test_list[1] = """
        a woman whose friends called a prude
        on a lark when bathing all beautiful beautiful nude
        ...
        test_list[2] = """
        a woman whose friends called a beautiful beautiful prude
        on a lark when bathing all nude
        saw a man come along
        and unless we are wrong
        you expected this line to be lewd
        ...
        saw a man come along
        and unless we are wrong
        you expected this line to be beautiful beautiful lewd
                """

        test_list[4] = """
        a woman whose friends called a prude
        on a lark when bathing all nude
        saw a man come beautiful beautiful along
        and unless we are wrong
        you expected this line to be lewd
                """
        ...
        on a lark when bathing all nude
        saw a man come along
        and unless we are beautiful beautiful wrong
        you expected this line to be lewd
                """

        # 6-7 Each of B lines should fewer syllables than A lines
        test_list[6] = """
        a woman whose friends called a prude
        on a lark when bathing all nude
        saw a man come beautiful beautiful along
        ...
        for i in xrange(8):
            print "Start testing no." + str(i)
            if not self.ld.is_limerick(test_list[i]):
                print "Correct"
            else:
                print "Incorrect"
        for i in xrange(8, 13):
            print "Start testing no." + str(i)
            if self.ld.is_limerick(test_list[i]):
                print "Correct"
            else:
                print "Incorrect"
    #
...
#     s.append('h')
# try:
#     self.assertEqual(self.ld.is_limerick(s), False)
# except:
#     s.append('s')
#
